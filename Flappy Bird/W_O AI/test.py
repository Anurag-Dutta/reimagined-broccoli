...
BACKGROUND = 'gallery/sprites/WinterSunset.jpg'
PIPE = 'gallery/sprites/RRR.png'
...
def welcomeScreen():
    ...
    messagex = int(SCREENWIDTH/2 - 100)
    messagey = int(SCREENHEIGHT/2 - 50)
    basex = 0
    while True:
...
def mainGame():
    ...
    while True:
        ...
        playery = playery + min(playerVelY, 1080 - playery - playerHeight)
